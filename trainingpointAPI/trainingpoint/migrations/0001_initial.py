# Generated by Django 5.0.6 on 2024-05-25 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(blank=True, choices=[(1, 'Admin'), (2, 'Cộng Tác Sinh Viên'), (3, 'Trợ Lý Sinh Viên'), (4, 'Sinh Viên')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trang_thai', models.IntegerField(blank=True, choices=[(0, 'Đăng Ký'), (1, 'Điểm Danh'), (2, 'Báo Thiếu')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anh_minh_chung', cloudinary.models.CloudinaryField(max_length=255, verbose_name='anh_minh_chung')),
